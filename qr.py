...
class MainApp(App):
    def build(self):
        ...
        # ایجاد تکس باکس‌ها
        self.name_input = TextInput(hint_text='نام')
        self.family_name_input = TextInput(hint_text='نام خانوادگی')
        self.id_number_input = TextInput(hint_text='شماره شناسنامه')
        self.national_id_input = TextInput(hint_text='شماره ملی')
    ...
    def submit_info(self, instance):
        ...
        img.export_to_png('user_qr.png') # ذخیره تصویر کد QR
        qr_image = kivy.uix.image.Image(source='user_qr.png')
